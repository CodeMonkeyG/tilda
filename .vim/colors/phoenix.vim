...
if s:accent == "yellow"
  hi Constant                 guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
  hi Directory                guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
  hi Type                     guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi SpecialKey               guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
  hi Conditional              guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi Exception                guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi Label                    guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi Repeat                   guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi Keyword                  guifg=#C3BA4D guibg=NONE    gui=NONE      ctermfg=227
  hi String                   guifg=#91812B guibg=NONE    gui=NONE      ctermfg=227
  hi Character                guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
  hi Boolean                  guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
  hi Number                   guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
endif
...
hi Todo                       guifg=#DEDD5A guibg=NONE    gui=bold      ctermfg=227   ctermbg=NONE
...
if s:accent == "yellow"
  hi IncSearch                guifg=#191919 guibg=#C3BA4D gui=NONE      ctermfg=255   ctermbg=227
  hi MatchParen               guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
  hi Search                   guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
endif
...
hi WarningMsg                 guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227   ctermbg=NONE
...
hi StatusLine                 guifg=#CCCCCC guibg=NONE    gui=NONE      ctermfg=235   ctermbg=NONE
hi StatusLineNC               guifg=#CCCCCC guibg=NONE    gui=NONE      ctermfg=235   ctermbg=NONE
...
if s:accent == "yellow"
  hi PmenuSel                 guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
  hi PmenuThumb               guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
  hi FoldColumn               guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
  hi Folded                   guifg=#191919 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=227
...
hi DiffChange                 guifg=#DEDD5A guibg=NONE    gui=bold      ctermfg=227
...
hi GitGutterChangeDefault     guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=227
...
hi SpellLocal                 guisp=#DEDD5A guibg=NONE    gui=undercurl  ctermfg=255  ctermbg=227   cterm=underline
hi SpellRare                  guisp=#DEDD5A guibg=NONE    gui=undercurl  ctermfg=255  ctermbg=227   cterm=underline
...
if s:accent == "yellow"
  hi helpHyperTextJump        guifg=#DEDD5A guibg=NONE    gui=underline ctermfg=227   ctermbg=NONE    cterm=underline
endif
